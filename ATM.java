...
public class ATM {
	...
	public static void showTransHistory(User aUser,Scanner s) {
		...
		do {
			...
			System.out.printf("Enter the number (1-%d) of the account whose transactions you want to see : ",aUser.numAccounts());
...
public static void transferFunds(User aUser ,Scanner s) {
		...
		do {
			System.out.printf("Enter the number (1-%d) of the account to transfer from :",aUser.numAccounts());
...
public static void depositeFunds(User aUser ,Scanner s) {
	...
	//inits
			...
			do {
				System.out.printf("Enter the number (1-%d) of the account\n to deposit into:",aUser.numAccounts());
				toAcct=s.nextInt()-1;
			...
			do {
				System.out.println("Amount must be greater than ZERO.");
				System.out.printf("Enter the amount to deposite (max Rs.%.02f): Rs.",acctBal);
				...
				if(amount<0) {
					...
					System.out.printf("Amount must  be greater than balance of Rs.%.02f.\n",acctBal);
